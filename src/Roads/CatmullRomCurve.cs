...
// Algo Catmull-Rom Spline  
// Defined a curve by four control points P0,P1,P2,P3
// The result drawn only from P1 to P2
...
public struct CatmullRomCurve {
	...
	//Rechape two points with the fonction LerpUnclamped
